        ...
        switch (widgetType) {
            ...
            case 1: {
                ...
                return {
                    ...
                    position: [dataAreaX, dataAreaY - gaugeRadius * 0.2, contentZ] as const,
            ...
            case 3: {
                ...
                return {
                    ...
                    lineUp,
                    lineDown,
                    position: [dataAreaX, dataAreaY, contentZ] as const
                };
            }
            case 4:
            case 5: {
                ...
                return {
                    ...
                    position: [dataAreaX - (barWidth * (1 - barValue)) / 2, dataAreaY, contentZ] as const,
                    bgPosition: [dataAreaX, dataAreaY, contentZ - 0.0001] as const
                };
            }
            default: {
...
export default function Laptop({ isDarkMode = false }: LaptopProps) {
    ...
    const keyboardLayout = useMemo(() => {
        ...
        const startY = keyboardTotalHeight / 2 - keySize / 2;
    ...
    return (
        <group ref={laptopGroupRef} dispose={null}>
            ...
            >
                ...
                <group position={[0, bodyHeight / 2 + 0.001, -0.2]}>
                ...
                <mesh
                    ...
                    position={[0, bodyHeight / 2 + 0.001, bodyDepth / 2 - touchpadHeight / 2 - 0.3]}
                    receiveShadow
                >
            ...
            >
                <mesh
                    material={materials.laptopBody}
                    position={[0, lidHeight / 2, lidDepth / 2 - hingeRadius]}
                    castShadow
                    receiveShadow
                >
                    ...
                    <mesh
                        ...
                        position={[0, lidHeight / 2 + 0.001, 0]}
                        receiveShadow
                    >
                    ...
                    <mesh
                        ...
                        position={[0, lidHeight / 2 + 0.002, screenHeight / 2 + screenBezel / 2]}
                    >
